...
} from "../../redux/slices/sliceUserInfos";
...
import imgEyeOpen from "../../assets/imgs/inputs/eyeOpen.png";
import imgEyeHide from "../../assets/imgs/inputs/eyeHide.png";
      ...
      .then((response) => {
        if (response.statusCode == true) {
          ...
          if (response.user) {
            ...
            GetTicketGateConfiguration(
              response.internalID ? response.internalID.toString() : ""
            ).then((response) => {
              console.log(
                "configuração da catraca indo pro dispatch",
                response
              );
    ...
    <>
      ...
      <form action="" className="login-form" onSubmit={handleSubmit}>
        ...
        <div className="container-input-password">
          ...
          <img
            src={showPassword ? imgEyeOpen : imgEyeHide}
            alt=""
            onClick={() => {
        ...
        <h6 className="login-form-forgot-password">
          <a href="/recuperarsenha" className="login-form-forgot-password-link">
