  ...
  return (
    <aside className={`sidebar ${isSidebarCollapsed ? "collapsed" : ""}`}>
      <header className="sidebar-header">
        <img
          src={logoNome}
          alt="Logo da evopass com o nome escrito"
          className="sidebar-header-img-logo-nome"
          onClick={() => navigate("/")}
        />
        <img
          src={setaLadoEsquerdo}
          alt="seta da sidebar apontando para o lado esquerdo"
          className="sidebar-header-img-seta-lado-esquerdo"
          onClick={toggleSidebar}
        />
        {isSidebarCollapsed && (
          <img
            src={logoCirculo}
            alt="Logo circular da Evopass"
            className="sidebar-header-img-logo-circular"
            onClick={() => navigate("/")}
          />
        )}
      </header>
      <ul className="sidebar-list-buttons">
          ...
          <>
            ...
            <li className="sidebar-list-buttons-li">
              <SidebarButton
                ...
                statusButton={
                  location.pathname == "/entrada-manual" ? true : false
                }
                isSidebarCollapsed={isSidebarCollapsed}
              />
            </li>
        ...
        <li className="sidebar-list-buttons-li">
          <SidebarButton
            ...
            statusButton={
              location.pathname == "/checkin-evoclub" ? true : false
            }
            isSidebarCollapsed={isSidebarCollapsed}
          />
        </li>
          ...
          <>
            <li className="sidebar-list-buttons-li">
              <SidebarButton
                ...
                route="/configuracoes"
                statusButton={
                  location.pathname == "/configuracoes" ? true : false
                }
                isSidebarCollapsed={isSidebarCollapsed}
              />
            </li>
